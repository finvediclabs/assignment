...
<body>
  ...
  <section class="home-section">
    ...
    <div class="overview-boxes">
        ...
        <div class="recent-stat box" style="width:100%;">
          ...
          <div class="stat-details">
            <ul class="details">
              ...
              <li>You can see the history of test taken and scores in the Results section</li>
              <li>To start the test, click on 'Start' button in the exam section.</li>
              <li>Once the test is started the timer would run irrespective of your logged in or logged our status. So it is recommended not to back before test completion.</li><br>
              <li>To mark an answer you need to select the option. Upon locking the selected options button will "blue".</li>
      ...
      </div> <!-- closes stat-boxes -->
    </div> <!-- closes home-content -->

        <footer style="background: #0b266f; color: #fff;   margin-top: 40px; width: 100%;">
